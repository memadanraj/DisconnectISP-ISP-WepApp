...
if (isset($_POST['bbid'])) {
    ...
    $stmt = $conn->prepare("SELECT b_title, DATE_FORMAT(b_pdate, '%Y/%m/%d') as b_pdate, b_img, b_content FROM `blog` WHERE b_id = ?");
                    ...
                    <div class="container my-5 pt-5 ">
                        <div class="row g-5 pt-5">
                            <div class="col-12 text-start ">
                                ...
                                <h1 class=" animated slideInDown"><?php echo $row['b_title']; ?></h1>
                                <hr class="  " style="width: 90px;">
                                <nav aria-label="breadcrumb">

                                    <ol class="breadcrumb justify-content-start">
                                        <p><i class="fa fa-calendar-alt"></i> <?php echo $row['b_pdate']; ?></p>
                                    </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 sidebar">
                        ...
                        <?php
                                            ...
                                            $sql = "SELECT b_id, DATE_FORMAT(b_pdate, '%Y/%m/%d') as b_pdate, b_title, b_img FROM `blog`  ORDER BY b_pdate DESC LIMIT 5";
                        ...
                        <div class=" mb-3 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                            <div class="rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="<?php echo $row['b_img'] ?>" alt="">
                                    <div class="portfolio-overlay">
                                        <form action="viewblog.php" method="post">
                                            <input type="hidden" value="<?php echo $row['b_id']; ?>" name="bid">
                                            <button class="btn btn-square btn-outline-light mx-1" name="bbid"
                                                type="submit"><i class="fa fa-link"></i></button>
                                        </form>
