...
if (isset($_POST['terms']) ) {
  include 'db/connect.php';
  $terms_idd=$_POST['termsid'];
  
  $terms_info = $_POST['termsCondition'];
    ...
    // Move the uploaded file
      ...
      $stmt = $conn->prepare("UPDATE `terms_pds` SET `terms_info` = ?  WHERE `terms_id` = ?");
      $stmt->bind_param("si", $terms_info, $terms_idd);
...
<html lang="en">
  <head>
    ...
    <title>PDS | Terms & Conditions</title>
    <link
  ...
  <body>
                  ...
                  <div class="card-body">
                    ...
                    { 
                        ...
                        { 
                          ...
                          ?>
                          <input type="hidden"   name="termsid" class="form-control" value="<?php echo $row['terms_id']?>" />
                      <div class="mb-3 row">
                      <!-- package mbps -->
                      <div class="mb-3 row">
                        <label class="col-sm-2">Terms And Conditions</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" name="termsCondition" id="termsCondition" cols="30" rows="10"><?php echo $row['terms_info']; ?></textarea>
                        </div>
                      </div>
                      <div class="line"></div>
                      <br />
                      ...
                      <div class="line">
                      <p > Last Update : <?php echo $row['terms_Update']; ?></p>
                      </div>
                      <br />
                      <br>
                      <div class="mb-3 row ">
    ...
    <!--
        ...
        <script>
            ...
            CKEDITOR.ClassicEditor.create(document.getElementById("termsCondition"), {
