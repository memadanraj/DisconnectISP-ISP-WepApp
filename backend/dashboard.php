...
<body>
    ...
    <nav id="sidebar" class="active">
            ...
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    <a href="package.html" ><i class="fas fa-server"></i>Pacakage</a>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="offermenu">
                            <li>
                                <a href="Slider.html"><i class="fas fa-angle-right"></i> Slider Offer</a>
                            </li>
                            <li>
                                <a href="popupOffer.html"><i class="fas fa-angle-right"></i> PopUp Offer</a>
                            </li>
                ...
                <li>
                    <a href="iptv.html"><i class="fas fa-tv"></i> IPTV</a>
                </li>
                <li>
                    <a href="Customer-msg.html">   <i class="fas fa-ticket-alt"></i> Tickets</a>
                </li>
                <li>
